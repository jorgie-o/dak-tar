...
<div class="row">
     <div class="col-8 offset-md-2">
        <div class="card-box">
            <h3 class="m-t-0 m-b-30">Create Patient</h3>
            ...
            <form action="{{ route('patients.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="age" name="age" parsley-trigger="change"
                           placeholder="Enter age" class="form-control" id="age" maxlength="10" required>
                </div>
                <div class="form-group">
